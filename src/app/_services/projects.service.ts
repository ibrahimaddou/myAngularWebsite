...
export class ProjectsService {
  projects : Project[]=
  [ { id:0,name:'Site Portfolio Angular',summary:'Projet fait avec angular',description:'',projectLink:'https://www.github.com/ibrahimaddou',tags:[Tag.ANGULAR,Tag.Bootstrap],pictures:["../../assets/img1.png","../../assets/img2.jpg"]},
